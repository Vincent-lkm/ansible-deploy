...
echo "💀 Kill ULTRA INFRA1 ALL - Bypass .bashrc - $(date)"
...
# Kill séquentiel sur TOUS les serveurs INFRA1
echo "🚀 Kill séquentiel ultra-robuste sur 74 serveurs..."
echo "⏰ Début: $(date)"
echo ""
...
echo ""
echo "✅ Kill ultra INFRA1 ALL terminé - $(date)"
echo "📊 74 serveurs traités"
echo "💀 Tous les processus update.sh tués sur INFRA1"
